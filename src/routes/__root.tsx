...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Gideon Farm Services — Admin Dashboard" },
      {
        name: "description",
        content:
          "Admin console for Gideon Farm Services petrol pump — manage workers, monitor autorickshaw diesel entries, and track coupon rewards.",
      },
      { name: "author", content: "Gideon Farm Services" },
